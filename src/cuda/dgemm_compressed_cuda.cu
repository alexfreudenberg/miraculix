/*
    ...
    This file is used as a demonstration for Julia integration of CUDA code
    It provides interfaces to cuSolver's dense and sparse cholesky decomposition.
    Special caution is advised for sparse routines, since the matrix formats in CUDA and Julia slightly differ

    Copyright (C) 2020 -- 2022 Alexander Freudenberg
